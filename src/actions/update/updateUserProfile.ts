...
export async function updateUserProfile(_: any, formData: FormData): Promise<ActionResponse> {
    ...
    try {
        const req = await ServerApiRequest.patch(apis.updateUserProfile(data.userId), data);
        ...
        if(res.statusCode == 201) {
            ...
            return {success: "Profile Updated", data: res.data.data};
        }
